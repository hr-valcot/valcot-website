...
export const metadata: Metadata = {
    title: "SME & Startups",
    description: "HR, Payroll, and Compliance solutions tailored for SMEs and Startups in Thailand.",
};
...
export default async function SMEPage({
    ...
    const painPoints = dict.industriesPages.sme.painPoints;
    const solutions = dict.industriesPages.sme.solutions;
                ...
                <div className="container-lg">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-4xl sm:text-5xl font-bold font-heading text-primary">
                            {dict.industriesPages.sme.title}
                        </h1>
                        <p className="mt-4 text-xl text-muted max-w-2xl">
                            {dict.industriesPages.sme.subtitle}
                        </p>
