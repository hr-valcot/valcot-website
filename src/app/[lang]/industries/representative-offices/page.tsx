...
export const metadata: Metadata = {
    ...
    description: "HR, Payroll, and EOR solutions for representative offices operating in Thailand.",
};

export default async function RepresentativeOfficePage({
    params,
}: {
    ...
    const painPoints = dict.industriesPages.representative.painPoints;
    const solutions = dict.industriesPages.representative.solutions;
                ...
                <div className="container-lg">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-4xl sm:text-5xl font-bold font-heading text-primary">
                            {dict.industriesPages.representative.title}
                        </h1>
                        <p className="mt-4 text-xl text-muted max-w-2xl">
                            {dict.industriesPages.representative.subtitle}
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            <h2 className="text-2xl font-bold font-heading text-primary mb-6">
                                {dict.industriesPages.commonPainPoints}
                            </h2>
